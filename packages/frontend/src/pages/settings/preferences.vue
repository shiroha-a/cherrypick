					...
					<div class="_gaps_s">
						<SearchMarker :keywords="['font', 'size']">
							<div style="width: 100%">
								...
								<SearchMarker :keywords="['koruri', 'font']">
									<MkSwitch v-model="useKoruri" style="margin-top: .75em;">
										<template #label><SearchLabel>Koruriフォントを使用</SearchLabel> <span class="_beta">Shiroha</span></template>
									</MkSwitch>
								</SearchMarker>
							</div>
...
// Koruriフォント使用トグル。内部的にはuseSystemFontキーを反転して扱う(Koruri ON = システムフォント無効)
